...
if ( ! class_exists( 'dien_tu_bk_Customize' ) ) {
	/**
	 * Customizer Settings.
	 *
	 * @since Dien Tu BK 1.0
	 */
	class dien_tu_bk_Customize {
		...
		public function register( $wp_customize ) {
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'Display Site Title & Tagline', 'dientubk' ),
				)
			);
			...
			$wp_customize->add_section(
				'excerpt_settings',
				array(
					'title'    => esc_html__( 'Excerpt Settings', 'dientubk' ),
					'priority' => 120,
				)
			);
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'On Archive Pages, posts show:', 'dientubk' ),
					'choices' => array(
						'excerpt' => esc_html__( 'Summary', 'dientubk' ),
						'full'    => esc_html__( 'Full text', 'dientubk' ),
					),
				)
			);
			...
			include_once get_theme_file_path( 'classes/class-dien-tu-bk-customize-color-control.php' ); // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound

			// Register the custom control.
			$wp_customize->register_control_type( 'dien_tu_bk_Customize_Color_Control' );
			...
			$wp_customize->add_control(
				new dien_tu_bk_Customize_Color_Control(
					$wp_customize,
					'background_color',
					array(
						'label'   => esc_html_x( 'Background color', 'Customizer control', 'dientubk' ),
						'section' => 'colors',
						'palette' => $colors,
					)
				)
