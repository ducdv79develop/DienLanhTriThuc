...
class AC_Care_Loader {
	 ...
	 * @return void
	 */
	public function ac_care_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function ac_care_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function ac_care_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function ac_care_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->ac_care_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function ac_care_load( $class ) {
